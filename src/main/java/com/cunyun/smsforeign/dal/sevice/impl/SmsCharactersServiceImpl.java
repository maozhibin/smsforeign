...
public class SmsCharactersServiceImpl implements SmsCharactersService {
    ...
    @Override
    public void smsCharacters(Account account,JsonResponseMsg result, ReqBody reqBody, List<SmsPlatform> smsPlatformsCharacters, List<String> LT, List<String> YD, List<String> DX) {
